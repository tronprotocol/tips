...
As part of the Ethereum Cancun upgrade, [EIP-5656: MCOPY - Memory copying instruction](https://eips.ethereum.org/EIPS/eip-5656) is required to be implemented to TRON.
...
the reduction by [EIP-2929](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-2929.md) made it slightly more economical.
...
With [EIP-2929](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-2929.md) the call overhead using the identity precompile was reduced from 700 to 100 gas.
