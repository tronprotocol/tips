...
```
  ...
  AccountPermissionUpdateContract {
    ...
    repeated Permission actives = 1;//Empty is invalidate
  }
  ...
  * @return The transaction 
  ...
  Permission {
    ...
    int64 threshold = 1;
    int32 parent_id = 1;
    bytes operations = 1;   //1 bit 1 contract
    repeated Key keys = 1;
  }
...
TransactionSignWeight {
  message Result {
    enum response_code {
      ...
      PERMISSION_ERROR = 1; //The key is not in permission
      OTHER_ERROR = 0;
    }
  ...
  Result result = 1;
  TransactionExtention transaction = 1;
}
