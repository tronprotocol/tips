...
(2) check the`roots`and verify the proof by [verifyTransferProof](https://github.com/tronprotocol/tips/pull/133)  function check the validity of the  `note_commitments`;
